...
# MAGIC Sometimes, when using **`if`** statements or other control flow structures, you need a no-op or placeholder for code that you plan to implement later. In such cases, you can use the **`pass`** statement. 
# MAGIC
# MAGIC [The **`pass`** statement](https://www.w3schools.com/python/ref_keyword_pass.asp) does nothing, allowing you to maintain the structure of your code without executing any specific actions.
# MAGIC
# MAGIC Let's look at an example of how the **`pass`** statement is used:
...
# MAGIC %md
# MAGIC
# MAGIC The **`pass`** statement serves as a placeholder, ensuring your code remains syntactically correct. It is often used when you're outlining your code and need to leave room for future development.
